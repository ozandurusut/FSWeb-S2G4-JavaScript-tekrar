...
function CemberinCevresi(cemberinCevreYaricapi) {
  return 2 * pi * cemberinCevreYaricapi;
}

/* (Oto test yok) Yukarıdaki CemberinCevresi fonksiyonunu yarıçap = 5 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin (console.log)  */
const cemberinCevreYaricapi = 5;
console.log(CemberinCevresi(cemberinCevreYaricapi));
...
function CemberinAlani(cemberinAlanYaricapi, pi) {
  return pi * Math.pow(cemberinAlanYaricapi, 2);
}

/* (Oto test yok) Yukarıdaki CemberinAlani fonksiyonunu yarıçap = 15 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin (console.log)  */
const cemberinAlanYaricapi = 15;
console.log(CemberinAlani(cemberinAlanYaricapi));
...
console.log("3'e tam bölünen sayılar toplamı:",ucebolunenlerintoplami);
...
console.log("500'den küçük sayılar küçükten büyüğe sıralandı:",siralisayilar);
